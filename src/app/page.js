...
export default async function Home() {
  return (
    <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-800 h-[100vh]">
      <section className="header">
        <Link href="/">
          <div className="fixed top-8 left-8 ">
            <div className="flex justify-center h-14 pt-2 cursor-pointer rounded-full">
              <Image
                width={50}
                height={80}
        ...
        <div className=" py-9">
          <h1 className="text-center text-5xl px-6 mr-6 font-bold text-white ">
            Welcome to Medville
          </h1>
        </div>
      </section>
      <section className="Platforms grid grid-cols-2 gap-x-4 mx-32 py-20">
        <Link href="/login" class="">
          <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
            <div class="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md bg-[url(https://img.freepik.com/free-photo/closeup-mature-woman-making-video-call-with-doctor-from-home_637285-7826.jpg?size=626&ext=jpg&ga=GA1.1.1079684755.1693089774&semt=ais)]"></div>

            <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 ">
              <h3 class="py-5 font-bold tracking-wide text-center text-blue-600 uppercase ">
                Patient Platform
              </h3>
        ...
        <Link href="/medicalprofessional" class="">
          <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
            <div class="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md bg-[url(https://img.freepik.com/free-photo/hands-unrecognizable-female-doctor-writing-form-typing-laptop-keyboard_1098-20374.jpg?size=626&ext=jpg&ga=GA1.1.1079684755.1693089774&semt=sph)]"></div>

            <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 ">
              <h3 class="py-2 font-bold tracking-wide text-center text-blue-600 uppercase ">
                Medical Professionals Platform
              </h3>
      ...
      <section>
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 pt-6">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex items-center mt-6">
              <p className="text-base leading-4 text-white">
                2023 <span className="font-semibold">Medville </span>
                by Tino👑.
              </p>
