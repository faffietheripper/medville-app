          ...
          <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
            <div className="flex items-center">
              ...
              <ul className="pr-32 xl:flex hidden items-center h-full">
                ...
                <li className="hover:text-indigo-700 cursor-pointer h-full w-36 flex items-center text-sm text-gry-800 mx-10 tracking-normal relative">
                  {product ? (
                    <ul className="bg-white shadow rounded py-1 left-0 mt-16 -ml-4 absolute  top-0">
                      <li className="cursor-pointer text-gray-600 text-sm  leading-3 tracking-normal border-b py-3 hover:bg-indigo-700 px-3 font-normal">
                        <Link href="/personaldetails"> Personal Details</Link>
                      </li>
                      <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal border-b py-3 hover:bg-indigo-700 px-3 font-normal">
                        <Link href="/medicalhistory"> Medical History</Link>
                      </li>
                      <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 px-3 font-normal">
                        <Link href="/testresults"> Test Results</Link>
                      </li>
                    </ul>
                  ) : (
                    ""
            ...
            <div className="h-full xl:flex hidden items-center justify-end">
              <div className="h-full flex items-center">
                ...
                <div className="w-full h-full flex">
                  ...
                  <Link
                    href="/notifications"
                    className="notificationbell w-16 xl:w-32 h-full flex items-center justify-center xl:border-r"
                  >
                    <div className="relative">
                      <div className="cursor-pointer w-6 h-6 xl:w-auto xl:h-auto text-gray-600">
                        <svg
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="avatar"
                    />
                    <p className="text-gray-800 text-sm ml-2">Tafadzwa Mpofu</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-blue-600 pt-8 pb-16 relative z-10">
          <div className="container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
            <div className="flex-col flex lg:flex-row items-start lg:items-center">
              <Link href="/gpdetails" className="flex items-center">
                <Image
                  height={50}
                  width={50}
