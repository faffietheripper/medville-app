...
export default function TestData() {
  return (
    <div>
      <div class="dark:bg-gray-900 p-9">
        <div class="mx-auto container w-full flex items-center md:flex-row flex-col justify-between px-6 lg:px-0">
          <div class="flex flex-col justify-start items-start lg:w-2/5 px-2 lg:px-0">
            <div>
              <p class="lg:text-sm text-xs text-gray-600 dark:text-gray-300 font-medium leading-none">
                Kanban Software
              </p>
            </div>
            <div class="md:mt-3">
              <p class="text-gray-800 dark:text-white lg:text-4xl text-3xl font-extrabold leading-9">
                Trello x Webber
              </p>
            </div>
            <div class="md:mt-3">
              <p class="lg:text-base text-sm leading-normal text-gray-600 dark:text-gray-300">
                Learn how Trello has leveraged Webber to consolidate its diverse
                range of services software
              </p>
            </div>
            <div class="grid grid-cols-2 mt-8 gap-y-6">
              <div>
                <p class="text-gray-800 dark:text-white text-sm lg:text-base font-medium leading-none">
                  Industry:{" "}
                  <span class="font-semibold md:font-medium">Technology</span>
                </p>
              </div>
              <div>
                <p class="text-gray-800 dark:text-white text-sm lg:text-base font-medium leading-none">
              ...
              <div>
                <p class="text-gray-800 dark:text-white text-sm lg:text-base font-medium leading-none">
                  Since: <span class="font-semibold md:font-medium">2018</span>
                </p>
              </div>
              <div>
                <p class="text-gray-800 dark:text-white text-sm lg:text-base font-medium leading-none">
                  Package:{" "}
                  <span class="font-semibold md:font-medium">Enterprise+ </span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="mx-auto container w-full flex xl:flex-row flex-col justify-between items-start mt-12 px-6 lg:px-0">
          <div class="flex flex-col justify-start items-start xl:w-2/4">
            <div>
              <h2 class="text-gray-800 dark:text-white lg:text-3xl text-2xl font-bold leading-7">
                The details
              </h2>
            </div>
            <div class="mt-8">
              <p class="text-gray-800 dark:text-white lg:text-base text-sm leading-normal">
                ...
                sentences will appear in the random paragraph.Another writing
                challenge can be to take the individual sentences in the random
                paragraph and incorporate a single sentence from that into a new
                paragraph to create a short story. Unlike the random sentence
                generator, the sentences from the random paragraph will have
                some connection to one another so it will be a bit different.
                You also won't know exactly how many sentences will appear in
            ...
            <div class="mt-8 flex justify-start items-start flex-col">
              <div>
                <p class="text-gray-800 dark:text-white lg:text-base text-sm font-semibold leading-none">
          ...
          <div class="md:px-8 px-4 lg:px-16 mt-10 xl:mt-0 h-full xl:w-2/5 w-full flex justify-center items-center bg-gradient-to-l from-indigo-600 to-indigo-700">
            <div class="flex flex-col lg:justify-start justify-center lg:items-start items-center my-10">
              ...
              <div class="mt-8 flex flex-row justify-start items-center space-x-4">
                <div class="">
                  <button class="btn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 text-xs lg:text-base border border-white py-2 px-4 md:py-4 md:px-8 bg-white rounded-sm text-indigo-700 hover:bg-gray-100">
                    Start trial
                  </button>
                </div>
                <div class="">
                  <button class="btn focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 text-xs lg:text-base border border-white py-2 px-4 md:py-4 md:px-8 text-white rounded-sm hover:bg-white hover:text-indigo-700">
                    Contact sales
                  </button>
                </div>
              </div>
